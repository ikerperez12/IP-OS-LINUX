...
const INITIAL_EMAILS: Email[] = [
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Meeting notes from today',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Security alert for your repository',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Project update - Phase 2 complete',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Your weekly tech digest',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Lunch next week?',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Your order has shipped!',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Code review feedback',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'New releases this month',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Happy New Year!',
  ...
  {
    id: '11', from: 'Security Team', fromEmail: 'security@iplinux.local',
    to: ['user@iplinux.local'], subject: 'Important: Password reset required',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'You won a prize!',
  ...
  {
    id: '13', from: 'me', fromEmail: 'user@iplinux.local',
  ...
  {
    id: '14', from: 'me', fromEmail: 'user@iplinux.local',
  ...
  {
    id: '15', from: 'me', fromEmail: 'user@iplinux.local',
  ...
  },
  {
    ...
    to: ['user@iplinux.local'], subject: 'Last month\'s deals',
...
const ComposeModal = memo(function ComposeModal({ onClose, onSend }: { onClose: () => void; onSend: (email: Omit<Email, 'id' | 'date' | 'isRead' | 'isStarred' | 'labels'>) => void }) {
  ...
  const handleSend = () => {
    ...
    onSend({ from: 'me', fromEmail: 'user@iplinux.local', to: [to], subject, body, folder: 'sent' });
    onClose();
  };
